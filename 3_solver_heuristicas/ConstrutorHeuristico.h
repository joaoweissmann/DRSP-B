...
class ConstrutorHeuristico
{
    ...
    public:
        ...
        std::tuple<Solucao, int> ConstruirSolucao(DadosDeEntrada dataset);
        std::tuple<Solucao, int> ConstruirSolucao(DadosDeEntrada dataset, std::map<Sonda, std::vector<Alocacao>> alocacoes);
};
