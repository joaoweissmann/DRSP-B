...
{
    public:
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> shift1x0InterRota(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
        ...
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> shift2x0InterRota(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
                                                                 const DadosDeEntrada & dataset, int estrutura, int modoRealoc,
                                                                 Alocacao alocacao1, Alocacao alocacao2, Sonda sonda2, int modoDebug, double fitness, double gastos, int totalFree);
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> swap1x1InterRota(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
                                                                 const DadosDeEntrada & dataset, int estrutura, int modoRealoc,
                                                                 Alocacao alocacao1, Alocacao alocacao2, int modoDebug, double fitness, double gastos, int totalFree);
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> swap2x1InterRota(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
                                                                 const DadosDeEntrada & dataset, int estrutura, int modoRealoc,
                                                                 Alocacao alocacao1, Alocacao alocacao2, Alocacao alocacao3, int modoDebug, double fitness, double gastos, int totalFree);
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> swap2x2InterRota(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
                                                                 const DadosDeEntrada & dataset, int estrutura, int modoRealoc,
        ...
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> reinsercao1InterRota(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
                                                                 const DadosDeEntrada & dataset, int estrutura, int modoRealoc,
                                                                 Alocacao alocacao1, int modoDebug, double fitness, double gastos, int totalFree);
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> reinsercao2InterRota(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
                                                                 const DadosDeEntrada & dataset, int estrutura, int modoRealoc,
                                                                 Alocacao alocacao1, Alocacao alocacao2, int modoDebug, double fitness, double gastos, int totalFree);
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> inserirNovoFO(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
        ...
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> swap1x1FO(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
                                                         DadosDeEntrada & dataset, int estrutura, int modoRealoc,
                                                         Alocacao alocacao1, Projeto projeto1, int modoDebug, double fitness, double gastos, int totalFree);
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> swap2x1FO(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
                                                         DadosDeEntrada & dataset, int estrutura, int modoRealoc,
                                                         Alocacao alocacao1, Alocacao alocacao2, Projeto projeto1, int modoDebug, double fitness, double gastos, int totalFree);
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> swap1x2FO(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
                                                         DadosDeEntrada & dataset, int estrutura, int modoRealoc,
                                                         Alocacao alocacao1, Projeto projeto1, Projeto projeto2, int modoDebug, double fitness, double gastos, int totalFree);
        std::tuple<std::map<Sonda, std::vector<Alocacao>>, double, double, int> swap2x2FO(const std::map<Sonda, std::vector<Alocacao>> & alocsMap, 
                                                         DadosDeEntrada & dataset, int estrutura, int modoRealoc,
                                                         Alocacao alocacao1, Alocacao alocacao2, 
