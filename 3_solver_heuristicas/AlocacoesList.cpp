                                     ...
                                     int prevMinus, int currMinus, int currPlus, int nextPlus, int caso, int modoDebug)
{
    ...
    {
        std::list<Alocacao>::iterator itrCurr;
        if (posicaoAloc == 999)
        {
        ...
        {
            std::list<Alocacao>::iterator itrTemp = std::prev(itrCurr, 1);
...
bool AlocacoesList::removerProjeto(Sonda sonda, Projeto projeto, int deltaT, int modoDebug)
{
    if (modoDebug == 1)
    {
        std::cout << std::endl;
